      ...
      <div class="page-breadcrumb">
          <div class="row">
              <div class="col-5 align-self-center">
                  <h4 class="page-title">Domain Provider</h4>
              </div>
                  ...
                  <div class="d-flex align-items-center justify-content-end">
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Domain Provider</li>
                          </ol>
                      </nav>
                  </div>
              </div>
          ...
          <div class="col-12  w-75 m-auto">
              <div class="card">
                  <div class="card-body">
                      ...
                      <form action='{{route('admin.insertHostingProvider')}}' method="POST" id="main_form" class="form-horizontal form-material mx-2">
                        @csrf

                        <div class="form-group d-flex">
                            <label class="col-sm-12" style="width: 25%;"> Domain Provider Name</label>
                            <div class="col-sm-12" style="width: 75%;">
                                <input name='hosting_provider_name' type="text" placeholder="Insert Client Type" class="form-control form-control-line">
                            </div>
                        </div>
           ...
           {{-- Edit form  --}}
                      <form action='{{route('admin.updateHostingProvider')}}' id="edit_form" method="POST" class="form-horizontal form-material mx-2" style="display: none">
                        @csrf

                        <div class="form-group d-flex">
                            <label class="col-sm-12" style="width: 25%;"> Hosting Provider Name</label>
                            <div class="col-sm-12" style="width: 75%;">
                                <input id="hosting_provider_name" name='hosting_provider_name' type="text" placeholder="Insert Client Type" class="form-control form-control-line">
                            </div>
                        </div>
                  ...
                  <div class="card">
                      <div class="table-responsive">
                          <table id="datatable" class="table table-hover table-bordered">
                              ...
                              <tbody>
                              @foreach($hosting_provider as $data)
                                  <tr>
                                  <!--  -->
                                      ...
                                      <form class="spacing" method="POST" action='{{url("admin/delete/hostingProviderModel/$data->id")}}' >
                                        @csrf
                                       @method('delete')
...
<script>
    $('.edit_btn').each(function(){
        ...
        $(this).on('click',function(){
            ...
            var hosting_provider_name= $(this).closest('tr').find("td:eq(1)").text();
            // console.log(domain_provider_name);
            $("#hosting_provider_name").val(hosting_provider_name);
            $("#carry_id").val(id);
            $("#main_form").hide();
           $("#edit_form").show();
        })
